...
public class InitDB {
    ...
    public void init() throws IOException {
        ...
        employee1.setBirthday(Common.stringToDate("1978-06-19"));
        employee1.setPhone("1234567890");
        employee1.setPosition(positionDao.findByTitle("waiter").get(0));
        employee1.setSalary(20000.0F);
        employeeDao.create(employee1);

        Employee employee2 = new Employee();
        employee2.setFirstName("Piter");
        employee2.setLastName("Grot");
        employee2.setBirthday(Common.stringToDate("1978-06-19"));
        employee2.setPhone("123411190");
        employee2.setPosition(positionDao.findByTitle("waiter").get(0));
        employee2.setSalary(21000.0F);
        employeeDao.create(employee2);

        Employee employee3 = new Employee();
        employee3.setFirstName("Piter");
        employee3.setLastName("Petrov");
        employee3.setBirthday(Common.stringToDate("1960-05-05"));
        employee3.setPhone("9876543210");
        employee3.setPosition(positionDao.findByTitle("cook").get(0));
        employee3.setSalary(23000.0F);
        employeeDao.create(employee3);

        Employee employee4 = new Employee();
        employee4.setFirstName("Saul");
        employee4.setLastName("Berrens");
        employee4.setBirthday(Common.stringToDate("1960-05-05"));
        ...
        employee5.setLastName("Green");
        employee5.setBirthday(Common.stringToDate("1980-05-13"));
        employee5.setPhone("09877763310");
        employee5.setPosition(positionDao.findByTitle("manager").get(0));
        employee5.setSalary(33000.0F);
        employeeDao.create(employee5);

        Employee employee6 = new Employee();
        employee6.setFirstName("BigTeddy");
        employee6.setLastName("Teddy");
        employee6.setBirthday(Common.stringToDate("1989-06-19"));
        employee6.setPhone("05088221797");
        employee6.setPosition(positionDao.findByTitle("hookah").get(0));
        employee6.setSalary(35000.0F);
        employeeDao.create(employee6);

        Employee employee7 = new Employee();
        employee7.setFirstName("Emeli");
        employee7.setLastName("Grot");
        employee7.setBirthday(Common.stringToDate("1983-02-28"));
        employee7.setPhone("9988352");
        employee7.setPosition(positionDao.findByTitle("hookah").get(0));
        employee7.setSalary(19060.0F);
        employeeDao.create(employee1);

        Employee employee8 = new Employee();
        employee8.setFirstName("Vasilii");
        employee8.setLastName("Petrov");
        employee8.setBirthday(Common.stringToDate("1976-05-21"));
        employee8.setPhone("06777991102");
