...
<div class="container">
    ...
    <div class="container">
        <div class="text-center">
            <img src='<c:url value="/image/main_menu.png"/>' width="300" height="180">
        </div>
    </div>
            ...
            <tr>
                ...
                <c:choose>
                    <c:when test="${not empty dishItem.value}">
                        <td style="vertical-align: middle" width="150px"> <img src="data:image/jpeg;base64,${dishItem.value}" width="145" height="169"/> </td>
                    </c:when>
                    <c:otherwise>
